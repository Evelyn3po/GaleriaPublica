...
public class GalleryPagingSource extends
    ...
    loadFuture(@NonNull PagingSource.LoadParams<Integer> loadParams) {
        ...
        ListenableFuture<PagingSource.LoadResult<Integer, ImageData>> lf =
                service.submit(new Callable<PagingSource.LoadResult<Integer, ImageData>>() {
                    ...
                    public PagingSource.LoadResult<Integer, ImageData> call() {
                        ...
                        try {
                            ...
                            return new PagingSource.LoadResult.Page<Integer,
